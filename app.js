(function(){
"use strict";
var DATA   = window.MAPDATA;               /* data/countries.js */
var DETAIL = window.MAPDETAIL || {};       /* data/detail.js, may load later */
...
/* lib/normalise.js, shared with build/generate.js so the page and the
   ambiguity check can never disagree about what a typed name folds to. */
var norm = Normalise.norm;
